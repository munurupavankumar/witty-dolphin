    ...
    <div id="cta" className="py-24 relative overflow-hidden">
      ...
      <div className="container relative mx-auto px-4">
        <div className="max-w-4xl mx-auto glass rounded-2xl p-8 md:p-12 text-center">
          <div className="absolute -top-10 -left-10 w-64 h-64 bg-dolphin-500/10 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-20 -right-10 w-72 h-72 bg-dolphin-500/10 rounded-full blur-3xl"></div>
