  ...
  return (
    <div className="relative min-h-screen flex items-center pt-16 overflow-hidden" ref={containerRef}>
      ...
      <div className="absolute inset-0 bg-dolphin-950 z-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-dolphin-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-dolphin-700/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            >
              <div className="inline-flex items-center rounded-full border border-dolphin-700 bg-dolphin-900/40 px-3 py-1 text-sm backdrop-blur-sm">
            ...
            <motion.p 
              className="text-lg md:text-xl text-gray-300/90"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-dolphin-600/30 shadow-2xl backdrop-blur-sm bg-dolphin-950/40">
              ...
              <div className="relative aspect-video">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-dolphin-950 to-transparent">
                  <p className="text-lg font-medium text-white/90 drop-shadow-md">Making knowledge accessible to the most ignored segments of India.</p>
                </div>
